...
public class SearchAdapter1 extends RecyclerView.Adapter<SearchAdapter1.SearchViewHolder> {
    ...
    public SearchAdapter1(Context context, ArrayList<String> title , ArrayList<String> price) {
    ...
    @Override
    public SearchAdapter1.SearchViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.mycart_view, parent, false);
...
//                ref.child("orders").child(Uid).child(title.get(position)).updateChildren(dataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
//                    @Override
